...
public final class DagDBGraph {
    ...
    @discardableResult
    public func addLeaf(label: String, rank: UInt64, truth: Bool) -> Int {
        let id = nodes.count
        nodes.append(Node(
            id: id, rank: rank,
    ...
    @discardableResult
    public func addGate(label: String, rank: UInt64, lut6: UInt64) -> Int {
        let id = nodes.count
        nodes.append(Node(
            id: id, rank: rank,
            lut6: lut6,
    ...
    @discardableResult
    public func addGhost(label: String, rank: UInt64) -> Int {
        let id = nodes.count
        nodes.append(Node(
            id: id, rank: rank,
