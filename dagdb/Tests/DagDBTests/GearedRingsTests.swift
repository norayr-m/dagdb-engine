...
final class GearedRingsTests: XCTestCase {
    ...
    func testSignedRecallAcrossOrders() throws {
    ...
    func testFinestResidentRingWins() throws {
        var r = try GearedRings(gear: 6, rings: 3, cellsPerRing: 4)
    ...
    func testBeyondHorizonIsNil() throws {
        var r = try GearedRings(gear: 6, rings: 2, cellsPerRing: 4)
    ...
    func testSealedShapeCapacity() throws {
        let r = try GearedRings()
        XCTAssertEqual(r.capacity, 192)
    }

    func testExtremumKeepsStrongestOfSpan() throws {
        var r = try GearedRings(gear: 6, rings: 2, cellsPerRing: 4)
